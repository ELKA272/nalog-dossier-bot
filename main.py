...
from config import TELEGRAM_BOT_TOKEN, OMNI_ROUTE_API_KEY, BASE_DIR
...
def main():
    ...
    if not OMNI_ROUTE_API_KEY:
        logger.warning("OMNI_ROUTE_API_KEY не задан — анализ рисков через DeepSeek недоступен")
